...
namespace legged {
class LeggedHilHW : public hardware_interface::RobotHW {
 public:
  LeggedHilHW() = default;
 ...
 protected:
  ...
  ImpedanceJointInterface impedanceJointInterface_;                 // NOLINT(misc-non-private-member-variables-in-classes)
