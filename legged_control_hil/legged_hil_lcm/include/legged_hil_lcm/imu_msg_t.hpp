...
int imu_msg_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int imu_msg_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int imu_msg_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t imu_msg_t::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* imu_msg_t::getTypeName()
{
    return "imu_msg_t";
}

int imu_msg_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int imu_msg_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int imu_msg_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
