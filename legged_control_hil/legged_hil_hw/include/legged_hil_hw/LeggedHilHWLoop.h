...
class LeggedHilHWLoop {  // NOLINT(cppcoreguidelines-special-member-functions)
 ...
 public:
   ...
   */
  LeggedHilHWLoop(ros::NodeHandle& nh, std::shared_ptr<LeggedHilHW> hardware_interface);
  ...
  **/
  ...
  std::shared_ptr<LeggedHilHW> hardwareInterface_;
